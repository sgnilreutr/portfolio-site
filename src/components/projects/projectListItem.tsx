...
const ProjectListItem = ({ noDay, project }: ProjectListItemProps) => {
  ...
  return (
    <li className="relative -mx-3">
      <Link href={toUseHref}>
        <div className="hover:bg-zinc-700 dark:hover:bg-zinc-800 grid grid-cols-[100px_1fr] gap-3 py-1.5 px-3 items-center grayscale-[35%] hover:grayscale-0 transition">
